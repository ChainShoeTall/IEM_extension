...
from neural_methods.loss.ownloss import ShortNPLoss, ShiftLoss
...
class PhysnetTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        self.PreTrainedModelPath = config.TRAIN.PREMODEL_PATH
        ...
        self.model.load_state_dict(torch.load(self.PreTrainedModelPath, map_location=config.DEVICE))
